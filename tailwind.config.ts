	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'feature': '0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 10px 10px -5px rgba(0, 0, 0, 0.01)',
				'button': '0 4px 14px 0 rgba(0, 0, 0, 0.08)'
			},
			backgroundImage: {
				'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
				'gradient-hero': 'linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%)',
				'gradient-feature': 'linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.7) 100%)'
			}
		}
	},
